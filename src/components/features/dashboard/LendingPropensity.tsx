...
const generateCustomers = (): Customer[] => {
  const industries = ['Manufacturing', 'Technology', 'Healthcare', 'Retail', 'Construction', 'Energy', 'Finance', 'Hospitality'];
  const customerNames = [
  ...
  return customers.sort((a, b) => b.lendingScore - a.lendingScore);
};
